...
class UserPlayerLikeController {
  static async getAllUserPlayerLikes(req: Request, res: Response): Promise<void> {
    try {
  ...
  static async getUserFollowedPlayers(req: Request, res: Response): Promise<void> {
    try {
  ...
  static async deleteUserPlayerLikeByUserId(req: Request, res: Response): Promise<void> {
    try {
    
      await UserPlayerLikeDao.deleteUserPlayerLike(req.body);
